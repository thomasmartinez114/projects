 ...
 * @author    Danish Ali Malik <email@example.com>
 * @license   GPL-2.0+
...
class Easy_Facebook_Likebox_Admin {
	...
	public function __construct() {
		...
		$this->plugin_slug = 'easy-facebook-likebox';
	...
	public function show_notice() { 
		...
		/* Getting the install date of the plugin. */
        $install_date = get_option('efbl_install_date', false);
        /* Current Date. */
		...
		$msg = sprintf(__('Awesome, you have been using the Easy Facebook Likebox Plugin from more than 1 week. <br> <br> If you like this plugin, please give a <a href="%s" target="_blank">5-star rating</a> on WordPress! <br> <br> This will help to spread its popularity and to make this plugin a better one.
			<br> <br>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document, "script", "twitter-wjs");</script>
		...
		echo "<div class='update-nag efbl-notice'>$msg</div>";
