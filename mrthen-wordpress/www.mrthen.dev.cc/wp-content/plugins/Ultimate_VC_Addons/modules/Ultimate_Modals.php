		...
		function modal_shortcode($atts, $content = null)
		{
			...
			if($modal_on == "button"){
				...
				if($btn_img !==''){
					...
					$html .= '<img src="'.$img[0].'" data-class-id="content-'.$uniq.'" class="ult-modal-img '.$init_extra_class.' '.$modal_class.' ult-align-'.$modal_on_align.' ult-modal-image-'.$el_class.'" '.$modal_data_class.'/>';
				}
			} 
