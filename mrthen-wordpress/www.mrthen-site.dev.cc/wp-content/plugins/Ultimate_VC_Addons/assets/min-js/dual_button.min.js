...
! function (t) {
    t(document).ready(function () {
        ...
        t(document).on("mouseenter", ".ult_dual1", function () {
            ...
            if ("Style3" == i) {
                var o = t(this).find(".ult-dual-btn-1").data("bghovercolor");
                t(this).css({
                    "box-shadow": " inset 0 0 20px 50px " + o
                })
            }
            if ("undefined" != i) {
                var a = t(this).find(".ult-dual-btn-1").data("icon_hover_color");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    color: a
                });
                var l = t(this).find(".ult-dual-btn-1").data("iconbghovercolor");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    background: l
                });
                var s = t(this).find(".ult-dual-btn-1").data("iconhoverborder");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    "border-color": s
                }), t(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    background: l
                }), t(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    "border-color": s
                });
                var u = t(this).find(".ult-dual-btn-1").data("texthovercolor");
                t(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({
                    color: u
                })
            }
        }), t(document).on("mouseleave", ".ult_dual1", function () {
            var i = t(this).find(".ult-dual-btn-1").attr("class"),
                n = i.split(" "),
                i = n[1] + n[2];
            if ("Style1" == i) {
                var d = t(this).find(".ult-dual-btn-1").data("bgcolor");
                t(this).css({
                    "background-color": d
                })
            }
            ...
            if ("undefined" != i) {
                var o = t(this).find(".ult-dual-btn-1").data("icon_color");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    color: o
                });
                var a = t(this).find(".ult-dual-btn-1").data("textcolor");
                t(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({
                    color: a
                });
                var l = t(this).find(".ult-dual-btn-1").data("iconbgcolor");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    background: l
                });
                var s = t(this).find(".ult-dual-btn-1").data("iconborder");
                t(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    "border-color": s
                }), t(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    background: l
        ...
        }), t(document).on("mouseenter", ".ult_dual2", function () {
            var i = t(this).find(".ult-dual-btn-2").attr("class"),
                n = i.split(" "),
                i = n[1] + n[2];
            if ("Style1" == i) {
                var o = t(this).find(".ult-dual-btn-2").data("bghovercolor");
                t(this).css({
                    "background-color": o
                })
            }
            ...
            if ("undefined" != i) {
                var a = t(this).find(".ult-dual-btn-2").data("icon_hover_color");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    color: a
                });
                var l = t(this).find(".ult-dual-btn-2").data("texthovercolor");
                t(this).find(".ult-dual-btn-2").find(".ult-dual-button-title").css({
                    color: l
                });
                var s = t(this).find(".ult-dual-btn-2").data("iconbghovercolor");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    background: s
                });
                var u = t(this).find(".ult-dual-btn-2").data("iconhoverborder");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    "border-color": u
                }), t(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({
                    background: s
                }), t(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({
                    "border-color": u
                })
            }
        }), t(document).on("mouseleave", ".ult_dual2", function () {
            var i = t(this).find(".ult-dual-btn-2").attr("class"),
                n = i.split(" "),
                i = n[1] + n[2];
            if ("Style1" == i) {
                var d = t(this).find(".ult-dual-btn-2").data("bgcolor");
                t(this).css({
                    "background-color": d
                })
            }
            ...
            if ("Style3" == i) {
                var d = t(this).find(".ult-dual-btn-2").data("bghovercolor");
                t(this).css({
                    "box-shadow": " inset 0 0 0 0 " + d
                })
            }
            if ("undefined" != i) {
                var o = t(this).find(".ult-dual-btn-2").data("icon_color");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    color: o
                });
                var a = t(this).find(".ult-dual-btn-2").data("textcolor");
                t(this).find(".ult-dual-btn-2").find(".ult-dual-button-title").css({
                    color: a
                });
                var l = t(this).find(".ult-dual-btn-2").data("iconbgcolor");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    background: l
                });
                var s = t(this).find(".ult-dual-btn-2").data("iconborder");
                t(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    "border-color": s
                }), t(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({
                    background: l
    ...
    }), t(document).on("mouseenter", ".ult_main_dualbtn", function () {
        t(this).data("bhcolor")
    }), t(document).on("mouseleave", ".ult_main_dualbtn", function () {
        t(this).data("bcolor")
    })
    ...
    jQuery(".ult_main_dualbtn").each(function () {
        ...
        var t = jQuery(this).find(".ult_dual1").outerHeight();
        t = parseInt(t);
        var i = jQuery(this).find(".ult_dual2").outerHeight();
        i = parseInt(i), t > i ? (jQuery(this).find(".ult_dual2").css({
            height: t
        }), jQuery(this).find(".ult_dual1").css({
            height: t
        })) : i > t ? (jQuery(this).find(".ult_dual1").css({
            height: i
        }), jQuery(this).find(".ult_dual2").css({
            height: i
        })) : t == i && (jQuery(this).find(".ult_dual1").css({
            height: i
        }), jQuery(this).find(".ult_dual2").css({
            height: i
        }));
        //jQuery(this).addClass('ult_setht');
    
     });


     jQuery(".ult_exp_section").select(function(){
       //console.log(jQuery(this).parent().find('.ult_main_dualbtn'));
		var t=0;
        var i=0;
        jQuery(this).parent().find(".ult_main_dualbtn").each(function () {
        	if(jQuery(this).hasClass('ult_setht')){
