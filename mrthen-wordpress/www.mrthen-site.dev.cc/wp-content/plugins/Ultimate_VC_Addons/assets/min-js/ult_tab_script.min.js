    ...
    a(".ult_tabs").each(function() {
        ...
        a(this).find("ul.ult_tabmenu").addClass("active").find("> li.ult_tab_li:eq(0)").addClass("current"), a(this).find("ul.ult_tabmenu li.ult_tab_li").each(function(b) {
          ...
          if(anm =='Slide'){
           ...
           ,
            c.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + j + ")").slideUp(500, function() {
                i > 0 && m()
            }), c.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + j + ")").slideDown(500), k = j, b.preventDefault();
          }
          else if(anm =='Fade'){
                "style2" == d || "style1" == d ? (l.find("a.ult_a").css({
                background: act_bg,
	 	...
	 	c.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + j + ")").fadeOut(100, function() {
            ...
            }), c.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + j + ")").fadeIn(1000), k = j, b.preventDefault();
          ...
          if(width>300 && width <660)
            {
               ...
               // jQuery(this).find('.ult_a ').css({'height':ht1});
            }
            else{
...
jQuery(this).find("ul.ult_tabmenu li a.ult_a").click(function(b) {
   ...
   /*  var cwidth=0;
jQuery(this).closest(".ult_tabs").find('.ult_tabitemname').each(function(){
                if (cwidth < jQuery(this).outerHeight()) {
                    cwidth = jQuery(this).outerHeight();
                }
            });*/


       jQuery(this).closest(".ult_tabs").find('.ult_tab_min_contain').css({'height':cwidth});
        var cwidth=jQuery(this).closest(".ult_tabs").find(".ult_tabitemname").css({'position':"absolute"});
    }
});
