...
if(isset($_POST['updateFile']))
{
    ...
    ////////////////////////////////////////////////////////////////////
            ...
            // Upload path
            $uploadPath = '../../uploads/cr/';

            // Set file name and ltrim to remove whitespace
            $fileName = ltrim($_POST['fileName']);

            // Set file path to uploads/cr/
            $uploadPath = $uploadPath.$trimmedPath;
            // echo "Upload path: ".$uploadPath;
    
            // $overwrite = $uploadPath.$trimmedPath;
            ...
            $query = "UPDATE $tableName SET fileName = '$fileName', fullName = '$uploadPath', modifiedBy = '$modifiedBy', modified = '$modified' WHERE id = '$id'";
